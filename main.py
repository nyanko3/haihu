...
class InvidiousAPI:
    def __init__(self):
        self.videos = ast.literal_eval(requests.get('https://gitlab.com/nyanko_a1/invidious/-/raw/main/instances.txt?ref_type=heads', headers=header, timeout=(1.0, 0.5)).text)
